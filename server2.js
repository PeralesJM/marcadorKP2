// IMPORTACION MODULOS
const servidorId = "server2";                                // Identificador del servidor
...
async function guardarEstadoEnBD() {                                              // Función asincrónica que guarda el estado en Supabase
  ...
  const { error } = await supabase
    ...
    .upsert([{                                                                    // Actualizar el estado de la tabla "marcador_tb"
      id: 2,                                                                      // Solo se gestiona un registro con id=1
...
const port = process.env.PORT || 3002;                                         // Arrancar el servidor en ese puerto
